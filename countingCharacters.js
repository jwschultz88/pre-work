...
function countingCharacters3(str, search) {
    ...
    /* we need to stop the loop based on multiple characters
    example: if searching "Ohio" with 3 characters at a time we want to stop at the h so we do not go past the end of the string */
